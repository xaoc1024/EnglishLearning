//
//  ANWordAudioDataRequestManager.m
//  Words Learning
//
...
@interface ANWordAudioDataRequestManager ()
@property (nonatomic) ANRequestsManager* requestManager;
@end

@implementation ANWordAudioDataRequestManager
...
- (void)downloadWord:(NSString*)word
{
    ...
    [self.requestManager requestWordAudioFileNamesForWord:preparedWord withCompletionBlock:^(id namesResultObject, NSError *error) {
